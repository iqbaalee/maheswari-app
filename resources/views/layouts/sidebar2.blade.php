...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ URL::asset('assets/images/logo-maheswari.png') }}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('assets/images/logo-mhs.png') }}" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="apps-file-manager" class="nav-link"> <span> @lang('translation.file-manager')</span> <span
                                        class="badge badge-pill bg-danger"> @lang('translation.new')</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="apps-todo" class="nav-link"> <span> @lang('translation.to-do')</span> <span
                                        class="badge badge-pill bg-danger"> @lang('translation.new')</span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="layout" class="icon-dual"></i> <span>@lang('translation.layouts')</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-crypto" class="nav-link"> <span>@lang('translation.crypto-svg')</span> <span
                                        class="badge badge-pill bg-danger">@lang('translation.new')</span></a>
                            </li>
                        </ul>
                    </div>
