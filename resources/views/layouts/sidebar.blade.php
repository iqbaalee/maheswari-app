    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- start schedule Menu -->
                <li class="nav-item">
                    <a class="nav-link" href="{{route('schedule.index')}}" aria-expanded="false">
                        <i data-feather="calendar" class="icon-dual"></i> <span>@lang('Schedule')</span>
                    </a>
                </li>
                <!-- end schedule Menu -->
                <!-- start booking Menu -->
                <li class="nav-item">
                    <a class="nav-link" href="booking" aria-expanded="false" aria-controls="sidebarCRM">
                        <i data-feather="file" class="icon-dual"></i> <span>@lang('Booking')</span>
                    </a>
                </li>
                <!-- end Booking Menu -->
                <!-- start product Menu -->
                <li class="nav-item">
                    <a class="nav-link" href="product" aria-expanded="false">
                        <i data-feather="grid" class="icon-dual"></i> <span>@lang('Product')</span>
                    </a>
                </li>
                <!-- end Product Menu -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="user" aria-expanded="false">
                        <i data-feather="user" class="icon-dual"></i> <span>@lang('User')</span>
                    </a>
                </li>
                <!-- end User Menu -->
