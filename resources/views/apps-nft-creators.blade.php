...
<div class="row g-4 mb-3">
    <div class="col-sm-auto">
        <div>
            <a href="apps-projects-create" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
        </div>
    </div>
    <div class="col-sm">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 4,754 ETH</p>
                    </div>
                    <div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 81,369 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 13,156 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 34,754 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 13,841 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 26,834 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 18,034 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="ms-3 flex-grow-1">
                        ...
                        <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i> 63,710 ETH</p>
                    </div>
                    <div>
                        <div class="dropdown float-end">
                            <button class="btn btn-ghost-primary btn-icon dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">9784 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">4678 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-secondary w-100">Follow</buttons>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">861 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">30174 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">6487 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-secondary w-100">Follow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">10137/ Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">364 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-secondary w-100">Follow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">9513 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">6374 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-secondary w-100">Follow</buttons>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted fs-14 mb-2">7809 Products</p>
                <p class="text-muted fs-14">You can make an NFT of a digital painting, a text, a piece of music, a video.</p>
                <buttons class="btn btn-soft-primary w-100">Unfollow</buttons>
            </div>
        </div>
