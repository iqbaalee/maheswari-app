    ...
    <div class="col-lg-12">
        <div class="d-lg-flex align-items-center mb-4">
            <div class="flex-grow-1">
                <h5 class="card-title mb-0 fw-bold fs-16">Trending Artwork</h5>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-2 flex-grow-1">
                        <h6 class="mb-1 fs-15">Nancy Martino</h6>
                        <p class="mb-0 fs-14 text-muted">Owners</p>
                    </div>
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-2 flex-grow-1">
                        <h6 class="mb-1 fs-15">Henry Baird</h6>
                        <p class="mb-0 fs-14 text-muted">Creators</p>
                    </div>
                    <div class="bookmark-icon">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-2 flex-grow-1">
                        <h6 class="mb-1 fs-15">Diana Kohler</h6>
                        <p class="mb-0 fs-14 text-muted">Owners</p>
                    </div>
                    <div class="bookmark-icon">
                        <button type="button" class="btn btn-icon active" data-bs-toggle="button" aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></button>
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-2 flex-grow-1">
                        <h6 class="mb-1 fs-15">James Price</h6>
                        <p class="mb-0 fs-14 text-muted">Owners</p>
                    </div>
                    <div class="bookmark-icon">
                        <button type="button" class="btn btn-icon" data-bs-toggle="button" aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></button>
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <img src="{{URL::asset('assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-circle" />
                    <div class="ms-2 flex-grow-1">
                        <h6 class="mb-1 fs-15">Rickey Teran</h6>
                        <p class="mb-0 fs-14 text-muted">Creators</p>
                    </div>
                    <div class="bookmark-icon">
                        <button type="button" class="btn btn-icon" data-bs-toggle="button" aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></button>
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Trendy Fashion Portraits</a></h5>
                <p class="text-muted fs-14 mb-0">3d Style</p>
            </div>
            <div class="card-footer border-top border-top-dashed">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 fs-14">
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a></h5>
                <p class="text-muted fs-14 mb-0">Crypto Card</p>
            </div>
            <div class="card-footer border-top border-top-dashed">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 fs-14">
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a></h5>
...
<div class="row">
    <div class="col-lg-12">
        <div class="d-lg-flex align-items-center mb-4">
            <div class="flex-grow-1">
                <h5 class="card-title mb-0 fw-bold fs-16">Popular Creators</h5>
            </div>
            <div class="flex-shrink-0 mt-4 mt-lg-0">
                <a href="apps-nft-creators" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
            </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile" class="link-dark">Tonya Noble</a></h5>
                <p class="text-muted fs-14">5048 Products</p>
                <div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile" class="link-dark">Kevin Dawson</a></h5>
                <p class="text-muted fs-14">649 Products</p>
                <div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile" class="link-dark">Herbert Stokes</a></h5>
                <p class="text-muted fs-14">918 Products</p>
                <div>
                    <button class="btn btn-soft-primary btn-sm">Unfollow</button>
                </div>
            </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile" class="link-dark">Thomas Taylor</a></h5>
                <p class="text-muted fs-14">345 Products</p>
                <div>
                    <button class="btn btn-primary btn-sm">Follow</button>
                </div>
            </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1 fs-15"><a href="pages-profile" class="link-dark">James Price</a></h5>
                <p class="text-muted fs-14">745 Products</p>
                <div>
                    <button class="btn btn-primary btn-sm">Follow</button>
                </div>
            </div>
