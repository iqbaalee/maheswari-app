        ...
        <div class="col-xl-8">
            <div class="card">
                    ...
                    <div class="row g-0 text-center">
                        ...
                        <div class="col-6 col-sm-3">
                            <div class="p-3 border border-dashed border-start-0 border-end-0">
                                <h5 class="mb-1 text-primary"><span class="counter-value" data-target="18.92">0</span>%
                                </h5>
                ...
                <div class="card-body p-0 pb-2">
                    <div class="w-100">
                        <div id="customer_impression_charts" data-colors='["--vz-light", "--vz-primary", "--vz-info"]'
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div id="sales-by-locations" data-colors='["--vz-light", "--vz-secondary", "--vz-primary"]'
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row align-items-center g-2">
                                ...
                                <div class="col">
                                    <div class="p-1">
                                        <div class="progress animated-progress progress-sm">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 29.32%"
                            ...
                            <div class="row align-items-center g-2">
                                ...
                                <div class="col">
                                    <div class="p-1">
                                        <div class="progress animated-progress progress-sm">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: 4.98%"
