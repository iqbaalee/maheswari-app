                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Bitcoin (BTC)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Ethereum (ETH)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Monero (XMR)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Maker (MKR)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Yearn.finance
                                                (YFI)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <tr>
                                    ...
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Litecoin (LTC)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <tr>
                                    ...
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Dash (DASH)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <tr>
                                    ...
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Neo (NEO)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                                ...
                                <tr>
                                    ...
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name link-secondary flex-grow-1 ms-2">Enzyme (MLN)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop"
                                    colors="primary:#25a0e2,secondary:#00bd9d" style="width:75px;height:75px"></lord-icon>
