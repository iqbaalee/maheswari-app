        ...
        <div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
            ...
            <div>
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <button class="btn btn-primary createFile-modal" data-bs-toggle="modal" data-bs-target="#createFileModal"><i class="ri-add-line align-bottom me-1"></i> Create File</button>
                    </div>
                </div>
    ...
    <div class="file-manager-detail-content p-3 py-0 border">
        <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
            <div id="folder-overview">
                ...
                <div id="simple_dount_chart" data-colors='["--vz-info", "--vz-warning", "--vz-primary", "--vz-success"]' class="apex-charts mt-3" dir="ltr"></div>
                <div class="mt-4">
                ...
                <div class="pb-3 mt-auto">
                    <div class="alert alert-success d-flex align-items-center mb-0">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <button class="btn btn-sm btn-success"><i class="ri-upload-cloud-line align-bottom"></i> Upgrade Now</button>
                        </div>
                    </div>
                </div>
            </div>
