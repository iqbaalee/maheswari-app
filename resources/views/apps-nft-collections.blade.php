    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Artwork <span class="badge badge-soft-primary">206</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Crypto Card <span class="badge badge-soft-primary">743</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Music <span class="badge badge-soft-primary">679</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Games <span class="badge badge-soft-primary">341</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Photography <span class="badge badge-soft-primary">1452</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">3d Style <span class="badge badge-soft-primary">4781</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Collectibles <span class="badge badge-soft-primary">3468</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                ...
                <!--end row-->
                <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Videos <span class="badge badge-soft-primary">1674</span></a></h5>
            </div>
        </div>
    </div>
    <!--end col-->
