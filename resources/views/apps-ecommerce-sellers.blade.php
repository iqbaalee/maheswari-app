            ...
            <div class="row g-2">
                ...
                <div class="col-lg-auto">
                    <div class="hstack gap-2">
                        <button type="button" class="btn btn-soft-info"><i class="ri-equalizer-fill me-1 align-bottom"></i>
                            Filters</button>
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSeller"><i
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Force
                            Medicines</a></h5>
                    <p class="text-muted mb-4">David Marshall</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller1" data-colors='["--vz-primary-rgb, 0.65"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                    ...
                    <div class="mt-4">
                        <a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="btn btn-light w-100">View Details</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Micro
                            Design</a></h5>
                    <p class="text-muted mb-4">Katia Stapleton</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller2" data-colors='["--vz-primary-rgb, 0.50"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Nesta
                            Technologies</a></h5>
                    <p class="text-muted mb-4">Harley Fuller</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller3" data-colors='["--vz-primary-rgb, 0.65"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">iTest
                            Factory</a></h5>
                    <p class="text-muted mb-4">Oliver Tyler</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller4" data-colors='["--vz-primary"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
            ...
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}"
                            class="link-secondary">Meta4Systems</a></h5>
                    <p class="text-muted mb-4">Zoe Dennis</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller5" data-colors='["--vz-primary-rgb, 0.50"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}"
                            class="link-secondary">Digitech Galaxy</a></h5>
                    <p class="text-muted mb-4">John Roberts</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller6" data-colors='["--vz-primary"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Syntyce
                            Solutions</a></h5>
                    <p class="text-muted mb-4">Demi Allen</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller7" data-colors='["--vz-primary-rgb, 0.50"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="mb-1 mt-4"><a href="{{URL::asset('/apps-ecommerce-seller-details')}}" class="link-secondary">Zoetic
                            Fashion</a></h5>
                    <p class="text-muted mb-4">James Bowen</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-seller8" data-colors='["--vz-primary-rgb, 0.65"]'></div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 border-end-dashed border-end">
                        ...
                        <div class="tab-pane" id="bankDetails" role="tabpanel">
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button class="btn btn-link link-priamry text-decoration-none fw-medium"
                                                data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i>
                                                Close</button>
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="ri-save-3-line align-bottom me-1"></i> Save</button>
