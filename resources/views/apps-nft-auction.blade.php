    ...
    <div class="col-xxl-9">
        ...
        <div class="row">
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="{{URL::asset('assets/images/nft/gif/img-1.gif')}}" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="{{URL::asset('assets/images/nft/gif/img-5.gif')}}" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                        <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h6>
                        <div>
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/gif/img-4.gif')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/gif/img-3.gif')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/users/avatar-10.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
