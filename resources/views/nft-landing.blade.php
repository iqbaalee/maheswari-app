...
@section('title') @lang('translation.nft-landing') @endsection
@section('css')
<!--Swiper slider css-->
        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="apps-nft-wallet" class="btn btn-primary btn-sm">Wallet Connect</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                ...
                                <a href="apps-nft-explore" class="btn btn-secondary">Explore Now <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h5>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a></h5>
                                <p class="text-muted fs-14 mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <a href="apps-nft-explore" class="btn btn-secondary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div><!-- end row -->
                <div class="row">
                ...
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            ...
                            <a href="apps-nft-explore" class="btn btn-secondary">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
