                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    <a href="{{ URL::asset('/auth-signup-basic') }}" class="btn btn-primary">Book Now <i
                    ...
                    <div class="swiper effect-coverflow-swiper rounded pb-5">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari1.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari2.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari3.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari4.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari5.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('assets/images/demos/maheswari6.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar1.jpg') }}"
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar2.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar3.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar4.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar5.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar6.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar7.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="card">
                                        <div class="card-body text-center p-4">
                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                <img src="{{ URL::asset('assets/images/users/avatar8.jpg') }}"
                                                    alt="" class="img-fluid rounded-circle">
                                                <a href="{{ URL::asset('/apps-mailbox') }}"
                                                    class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                                    <div class="avatar-title bg-transparent">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="text-center mt-2">
                                        <a href="{{ URL::asset('/pages-team') }}" class="btn btn-primary">View All
                                            Members
