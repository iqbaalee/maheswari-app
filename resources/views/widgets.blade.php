            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-primary border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{URL::asset('/pages-pricing')}}" class="text-reset text-decoration-underline"><b>Upgrade</b></a>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="{{URL::asset('/pages-pricing')}}" class="btn btn-primary">Upgrade
                                        Account!</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-primary border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{URL::asset('/pages-pricing')}}" class="text-reset text-decoration-underline"><b>Get Free
                                    Gift</b></a>
                        </div>
                    </div>
                    <div class="d-flex p-3">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <a href="{{URL::asset('/pages-pricing')}}" class="btn btn-secondary">Get a Free
                                    Gift</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="countries_charts"
                            data-colors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-info", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]'
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div id="color_heatmap"
                        data-colors='["--vz-info", "--vz-success", "--vz-primary", "--vz-warning", "--vz-secondary"]'
